...
description: Intel Xe2 GPU (Battlemage G21) optimization guide for SYCL kernels
license: MIT
...
# Intel Xe2 GPU Optimization Guide

Optimization guide for SYCL kernels on Intel Xe2 (Battlemage) architecture.

## Architecture Overview

```
Intel Graphics [0xe211] - Xe2/BMG
├── Sub-group: 16 (fixed)
