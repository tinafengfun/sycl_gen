...
description: Intel BMG B60 GPU optimization skill for SYCL kernels. Provides architecture-specific optimizations for work-group tuning, loop unrolling, and memory access patterns.
license: MIT
...
针对 Intel BMG B60 GPU 提供 SYCL kernel 优化指导。

### 架构特性

```
Intel BMG B60 - Battlemage G21
├── Sub-group: 16 (固定值)
