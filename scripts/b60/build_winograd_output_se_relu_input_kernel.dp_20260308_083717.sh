#!/bin/bash
# SYCL Build Script for BMG/XPU - Generated 20260308_083717
...
echo "Timestamp: 20260308_083717"
...
icpx -fsycl -O2 -std=c++17 -fsycl-unnamed-lambda -sycl-std=2020 -fhonor-nans -fhonor-infinities -fno-associative-math -fno-approx-func -no-ftz -fsycl-targets=spir64_gen,spir64 \
  ...
  2>&1 | tee "/workspace/results/b60/compile_winograd_output_se_relu_input_kernel.dp_20260308_083717.log.step1"
...
icpx -fsycl -fsycl-max-parallel-link-jobs=4 --offload-compress -fsycl-targets=spir64_gen,spir64 -Xs '-device pvc,bmg,dg2,arl-h,mtl-h,lnl-m,ptl-h,ptl-u -options -cl-poison-unsupported-fp64-kernels -options -cl-intel-enable-auto-large-GRF-mode -options -cl-fp32-correctly-rounded-divide-sqrt -options -cl-intel-greater-than-4GB-buffer-required' \
  ...
  2>&1 | tee "/workspace/results/b60/compile_winograd_output_se_relu_input_kernel.dp_20260308_083717.log.step2"
...
# 合并日志
cat "/workspace/results/b60/compile_winograd_output_se_relu_input_kernel.dp_20260308_083717.log.step1" > "/workspace/results/b60/compile_winograd_output_se_relu_input_kernel.dp_20260308_083717.log"
if [ -f "/workspace/results/b60/compile_winograd_output_se_relu_input_kernel.dp_20260308_083717.log.step2" ]; then
    echo "" >> "/workspace/results/b60/compile_winograd_output_se_relu_input_kernel.dp_20260308_083717.log"
    echo "=== Device Link Step ===" >> "/workspace/results/b60/compile_winograd_output_se_relu_input_kernel.dp_20260308_083717.log"
    cat "/workspace/results/b60/compile_winograd_output_se_relu_input_kernel.dp_20260308_083717.log.step2" >> "/workspace/results/b60/compile_winograd_output_se_relu_input_kernel.dp_20260308_083717.log"
fi
