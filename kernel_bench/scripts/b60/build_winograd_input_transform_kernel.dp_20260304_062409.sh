#!/bin/bash
# SYCL Build Script - Generated 20260304_062409
...
echo "Timestamp: 20260304_062409"
...
icpx -fsycl -O2 -std=c++17 \
  ...
  2>&1 | tee "/workspace/results/b60/compile_winograd_input_transform_kernel.dp_20260304_062409.log"
