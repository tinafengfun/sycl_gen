...
// V2: 1D flattened (for comparison)
namespace v2 {
inline int DivUp(int a, int b) { return (a + b - 1) / b; }
...
int main() {
    ...
    for (int N : sizes) {
        ...
        double total_ops = (double)N * C * (H/4) * (W/4) * 36 * 2;
    ...
    csv.close();
    std::cout << std::endl << "✅ Winograd Input Transform testing completed!" << std::endl;
    return 0;
}
